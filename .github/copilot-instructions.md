...
Make regular git commits after fixing an item. A big problems is udating and fixing items and not commiting them and waiting until push. If they are committed locally in increments, they can always be updated prior to push and as well there is local history that is easily wound back if needed.
