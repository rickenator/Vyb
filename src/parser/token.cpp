...
std::string token_type_to_string(vyn::TokenType type) { // Corrected namespace for TokenType
    static const std::unordered_map<vyn::TokenType, std::string> token_map = { // Corrected namespace for TokenType
        ...
        {vyn::TokenType::KEYWORD_ASPECT, "KEYWORD_ASPECT"},
        {vyn::TokenType::KEYWORD_BIND, "KEYWORD_BIND"},
        ...
        {vyn::TokenType::KEYWORD_MILD, "KEYWORD_MILD"},
        ...
        {vyn::TokenType::KEYWORD_TYPEOF, "KEYWORD_TYPEOF"},
        {vyn::TokenType::KEYWORD_TYPENAME, "KEYWORD_TYPENAME"},
