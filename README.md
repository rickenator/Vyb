...
# Run the full test suite (1151 .vyb tests) with the canonical harness
...
### Test Features
- **1151 Tests, All Passing**: The full `run_tests.py` suite covers parse, semantic, modules, async, agents, tls, qt, and every other feature area
...
#### **Test Statistics**
- **Total Tests**: 1151 `.vyb` tests (full suite, all passing as of v0.7.5)
...
- **Success Rate**: 100% (1151/1151) on the current suite
...
- ✅ **Modern Test Harness**: `test/run_tests.py` running the full suite — 1151 `.vyb` tests all passing — with an auxiliary parallel/HTML/triage harness
