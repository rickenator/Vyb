...
# Run the full test suite (1155 .vyb tests) with the canonical harness
...
### Test Features
- **1155 Tests, All Passing**: The full `run_tests.py` suite covers parse, semantic, modules, async, agents, tls, qt, and every other feature area
...
#### **Test Statistics**
- **Total Tests**: 1155 `.vyb` tests (full suite, all passing as of v0.7.5)
...
- **Success Rate**: 100% (1155/1155) on the current suite
...
- ✅ **Modern Test Harness**: `test/run_tests.py` running the full suite — 1155 `.vyb` tests all passing — with an auxiliary parallel/HTML/triage harness
