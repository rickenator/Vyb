...
for.body:                                         ; preds = %for.cond
  %sum2 = load i64, ptr %sum, align 4, !dbg !11
  %i3 = load i64, ptr %i, align 4, !dbg !11
  %addtmp = add i64 %sum2, %i3, !dbg !11
...
for.exit:                                         ; preds = %for.cond
  %sum6 = load i64, ptr %sum, align 4, !dbg !11
  ret i64 %sum6, !dbg !11
}
...
!1 = !DIFile(filename: "test_basic.vyn.ll", directory: "/home/rick/Projects/Vyn/test/vec_for")
...
!8 = !{!9, !10}
!9 = !DILocalVariable(name: "sum", scope: !4, file: !1, line: 2, type: !7)
!10 = !DILocalVariable(name: "i", scope: !4, file: !1, line: 3, type: !7)
!11 = !DILocation(line: 1, column: 1, scope: !4)
!12 = !DILocation(line: 2, column: 1, scope: !4)
!13 = !DILocation(line: 3, column: 10, scope: !4)
