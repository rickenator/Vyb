...
entry:
  %x = alloca i64, align 8, !dbg !18
  %__len_x = alloca i64, align 8, !dbg !18
  %__idx_x = alloca i64, align 8, !dbg !18
  %__run_once_x = alloca i1, align 1, !dbg !18
  %count = alloca i64, align 8, !dbg !18
  %sum = alloca i64, align 8, !dbg !18
  %v = alloca { ptr, i64, i64 }, align 8, !dbg !18
  ...
  store { ptr, i64, i64 } %vec.new.value, ptr %v, align 8, !dbg !18
  call void @llvm.dbg.declare(metadata ptr %v, metadata !9, metadata !DIExpression()), !dbg !19
  %vec.data_ptr = getelementptr inbounds { ptr, i64, i64 }, ptr %v, i32 0, i32 0, !dbg !18
  %vec.size_ptr = getelementptr inbounds { ptr, i64, i64 }, ptr %v, i32 0, i32 1, !dbg !18
  %vec.cap_ptr = getelementptr inbounds { ptr, i64, i64 }, ptr %v, i32 0, i32 2, !dbg !18
...
vec.merge:                                        ; preds = %vec.no_copy, %entry
  ...
  store i64 1, ptr %vec.element_ptr, align 4, !dbg !18
  %vec.new_size = add i64 %vec.reloaded_size, 1, !dbg !18
  store i64 %vec.new_size, ptr %vec.size_ptr, align 4, !dbg !18
  %vec.data_ptr1 = getelementptr inbounds { ptr, i64, i64 }, ptr %v, i32 0, i32 0, !dbg !18
  %vec.size_ptr2 = getelementptr inbounds { ptr, i64, i64 }, ptr %v, i32 0, i32 1, !dbg !18
  %vec.cap_ptr3 = getelementptr inbounds { ptr, i64, i64 }, ptr %v, i32 0, i32 2, !dbg !18
...
vec.merge13:                                      ; preds = %vec.no_copy12, %vec.merge
  ...
  store i64 2, ptr %vec.element_ptr22, align 4, !dbg !18
  %vec.new_size23 = add i64 %vec.reloaded_size20, 1, !dbg !18
  store i64 %vec.new_size23, ptr %vec.size_ptr2, align 4, !dbg !18
  %vec.data_ptr24 = getelementptr inbounds { ptr, i64, i64 }, ptr %v, i32 0, i32 0, !dbg !18
  %vec.size_ptr25 = getelementptr inbounds { ptr, i64, i64 }, ptr %v, i32 0, i32 1, !dbg !18
  %vec.cap_ptr26 = getelementptr inbounds { ptr, i64, i64 }, ptr %v, i32 0, i32 2, !dbg !18
...
vec.merge36:                                      ; preds = %vec.no_copy35, %vec.merge13
  ...
  store i64 3, ptr %vec.element_ptr45, align 4, !dbg !18
  %vec.new_size46 = add i64 %vec.reloaded_size43, 1, !dbg !18
  store i64 %vec.new_size46, ptr %vec.size_ptr25, align 4, !dbg !18
  %vec.data_ptr47 = getelementptr inbounds { ptr, i64, i64 }, ptr %v, i32 0, i32 0, !dbg !18
  %vec.size_ptr48 = getelementptr inbounds { ptr, i64, i64 }, ptr %v, i32 0, i32 1, !dbg !18
  %vec.cap_ptr49 = getelementptr inbounds { ptr, i64, i64 }, ptr %v, i32 0, i32 2, !dbg !18
...
vec.merge59:                                      ; preds = %vec.no_copy58, %vec.merge36
  ...
  store i64 4, ptr %vec.element_ptr68, align 4, !dbg !18
  %vec.new_size69 = add i64 %vec.reloaded_size66, 1, !dbg !18
  store i64 %vec.new_size69, ptr %vec.size_ptr48, align 4, !dbg !18
  %vec.data_ptr70 = getelementptr inbounds { ptr, i64, i64 }, ptr %v, i32 0, i32 0, !dbg !18
  %vec.size_ptr71 = getelementptr inbounds { ptr, i64, i64 }, ptr %v, i32 0, i32 1, !dbg !18
  %vec.cap_ptr72 = getelementptr inbounds { ptr, i64, i64 }, ptr %v, i32 0, i32 2, !dbg !18
...
vec.merge82:                                      ; preds = %vec.no_copy81, %vec.merge59
  ...
  store i64 5, ptr %vec.element_ptr91, align 4, !dbg !18
  %vec.new_size92 = add i64 %vec.reloaded_size89, 1, !dbg !18
  store i64 %vec.new_size92, ptr %vec.size_ptr71, align 4, !dbg !18
  store i64 0, ptr %sum, align 4, !dbg !18
  call void @llvm.dbg.declare(metadata ptr %sum, metadata !11, metadata !DIExpression()), !dbg !20
  store i64 0, ptr %count, align 4, !dbg !18
  call void @llvm.dbg.declare(metadata ptr %count, metadata !12, metadata !DIExpression()), !dbg !21
  br label %for.init, !dbg !18

for.init:                                         ; preds = %vec.merge82
  store i1 true, ptr %__run_once_x, align 1, !dbg !18
  call void @llvm.dbg.declare(metadata ptr %__run_once_x, metadata !13, metadata !DIExpression()), !dbg !22
  br label %for.cond, !dbg !18

for.cond:                                         ; preds = %for.update, %for.init
  %__run_once_x93 = load i1, ptr %__run_once_x, align 1, !dbg !18
  br i1 %__run_once_x93, label %for.body, label %for.exit, !dbg !18

for.body:                                         ; preds = %for.cond
  store i64 0, ptr %__idx_x, align 4, !dbg !18
  call void @llvm.dbg.declare(metadata ptr %__idx_x, metadata !15, metadata !DIExpression()), !dbg !22
  %vec.size_ptr94 = getelementptr inbounds { ptr, i64, i64 }, ptr %v, i32 0, i32 1, !dbg !18
  %vec.len = load i64, ptr %vec.size_ptr94, align 4, !dbg !18
  store i64 %vec.len, ptr %__len_x, align 4, !dbg !18
  call void @llvm.dbg.declare(metadata ptr %__len_x, metadata !16, metadata !DIExpression()), !dbg !22
  br label %loop.header, !dbg !18

for.update:                                       ; preds = %loop.exit
  store i1 false, ptr %__run_once_x, align 1, !dbg !18
  br label %for.cond, !dbg !18

for.exit:                                         ; preds = %for.cond
  %sum110 = load i64, ptr %sum, align 4, !dbg !18
  %v_cleanup_load = load { ptr, i64, i64 }, ptr %v, align 8, !dbg !18
  %v_data_ptr = extractvalue { ptr, i64, i64 } %v_cleanup_load, 0, !dbg !18
  %v_null_check = icmp ne ptr %v_data_ptr, null, !dbg !18
  br i1 %v_null_check, label %v_free_block, label %v_continue, !dbg !18

loop.header:                                      ; preds = %ifcont, %then, %for.body
  %__idx_x95 = load i64, ptr %__idx_x, align 4, !dbg !18
  %__len_x96 = load i64, ptr %__len_x, align 4, !dbg !18
  %icmpslttmp = icmp slt i64 %__idx_x95, %__len_x96, !dbg !18
  br i1 %icmpslttmp, label %loop.body, label %loop.exit, !dbg !18

loop.body:                                        ; preds = %loop.header
  %__idx_x97 = load i64, ptr %__idx_x, align 4, !dbg !18
  %vec.data_ptr98 = getelementptr inbounds { ptr, i64, i64 }, ptr %v, i32 0, i32 0, !dbg !18
  %vec.size_ptr99 = getelementptr inbounds { ptr, i64, i64 }, ptr %v, i32 0, i32 1, !dbg !18
  %vec.data100 = load ptr, ptr %vec.data_ptr98, align 8, !dbg !18
  %vec.size = load i64, ptr %vec.size_ptr99, align 4, !dbg !18
  %vec.offset101 = mul i64 %__idx_x97, 8, !dbg !18
  %vec.element_ptr102 = getelementptr i8, ptr %vec.data100, i64 %vec.offset101, !dbg !18
  %vec.element = load i64, ptr %vec.element_ptr102, align 4, !dbg !18
  store i64 %vec.element, ptr %x, align 4, !dbg !18
  call void @llvm.dbg.declare(metadata ptr %x, metadata !17, metadata !DIExpression()), !dbg !22
  %count103 = load i64, ptr %count, align 4, !dbg !18
  %addtmp = add i64 %count103, 1, !dbg !18
  store i64 %addtmp, ptr %count, align 4, !dbg !18
  %count104 = load i64, ptr %count, align 4, !dbg !18
  %icmpeqtmp = icmp eq i64 %count104, 3, !dbg !18
...
ifcont:                                           ; preds = %loop.body
  %sum105 = load i64, ptr %sum, align 4, !dbg !18
  %x106 = load i64, ptr %x, align 4, !dbg !18
  %addtmp107 = add i64 %sum105, %x106, !dbg !18
  store i64 %addtmp107, ptr %sum, align 4, !dbg !18
  %__idx_x108 = load i64, ptr %__idx_x, align 4, !dbg !18
  %addtmp109 = add i64 %__idx_x108, 1, !dbg !18
  store i64 %addtmp109, ptr %__idx_x, align 4, !dbg !18
  br label %loop.header, !dbg !18

v_free_block:                                     ; preds = %for.exit
  call void @free(ptr %v_data_ptr), !dbg !18
  br label %v_continue, !dbg !18

v_continue:                                       ; preds = %v_free_block, %for.exit
  ret i64 %sum110, !dbg !18
}
...
!1 = !DIFile(filename: "vec_with_continue.vyn.ll", directory: "/home/rick/Projects/Vyn/test/vec_for")
...
!12 = !DILocalVariable(name: "count", scope: !4, file: !1, line: 11, type: !7)
!13 = !DILocalVariable(name: "__run_once_x", scope: !4, file: !1, line: 12, type: !14)
!14 = !DIBasicType(name: "bool", size: 1, encoding: DW_ATE_boolean)
!15 = !DILocalVariable(name: "__idx_x", scope: !4, file: !1, line: 12, type: !7)
!16 = !DILocalVariable(name: "__len_x", scope: !4, file: !1, line: 12, type: !7)
!17 = !DILocalVariable(name: "x", scope: !4, file: !1, line: 12, type: !7)
!18 = !DILocation(line: 2, column: 1, scope: !4)
!19 = !DILocation(line: 3, column: 1, scope: !4)
!20 = !DILocation(line: 10, column: 1, scope: !4)
!21 = !DILocation(line: 11, column: 1, scope: !4)
!22 = !DILocation(line: 12, column: 10, scope: !4)
