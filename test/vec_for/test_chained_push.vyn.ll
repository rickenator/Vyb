...
vec.merge36:                                      ; preds = %vec.no_copy35, %vec.merge13
  ...
  %vec.data_ptr47 = getelementptr inbounds { ptr, i64, i64 }, ptr %numbers, i32 0, i32 0, !dbg !17
  %vec.size_ptr48 = getelementptr inbounds { ptr, i64, i64 }, ptr %numbers, i32 0, i32 1, !dbg !17
  %vec.cap_ptr49 = getelementptr inbounds { ptr, i64, i64 }, ptr %numbers, i32 0, i32 2, !dbg !17
...
vec.merge59:                                      ; preds = %vec.no_copy58, %vec.merge36
  ...
  store i64 40, ptr %vec.element_ptr68, align 4, !dbg !17
  %vec.new_size69 = add i64 %vec.reloaded_size66, 1, !dbg !17
  store i64 %vec.new_size69, ptr %vec.size_ptr48, align 4, !dbg !17
  %vec.data_ptr70 = getelementptr inbounds { ptr, i64, i64 }, ptr %numbers, i32 0, i32 0, !dbg !17
  %vec.size_ptr71 = getelementptr inbounds { ptr, i64, i64 }, ptr %numbers, i32 0, i32 1, !dbg !17
  %vec.cap_ptr72 = getelementptr inbounds { ptr, i64, i64 }, ptr %numbers, i32 0, i32 2, !dbg !17
...
vec.merge82:                                      ; preds = %vec.no_copy81, %vec.merge59
  ...
  store i64 50, ptr %vec.element_ptr91, align 4, !dbg !17
...
for.cond:                                         ; preds = %for.update, %for.init
  %__run_once_num93 = load i1, ptr %__run_once_num, align 1, !dbg !17
  br i1 %__run_once_num93, label %for.body, label %for.exit, !dbg !17

for.body:                                         ; preds = %for.cond
  %vec.size_ptr94 = getelementptr inbounds { ptr, i64, i64 }, ptr %numbers, i32 0, i32 1, !dbg !17
  %vec.len = load i64, ptr %vec.size_ptr94, align 4, !dbg !17
  store i64 %vec.len, ptr %__len_num, align 4, !dbg !17
  call void @llvm.dbg.declare(metadata ptr %__len_num, metadata !14, metadata !DIExpression()), !dbg !20
...
for.exit:                                         ; preds = %for.cond
  %sum112 = load i64, ptr %sum, align 4, !dbg !17
...
for.init95:                                       ; preds = %for.body
  ...
  call void @llvm.dbg.declare(metadata ptr %__idx_num, metadata !15, metadata !DIExpression()), !dbg !20
  br label %for.cond96, !dbg !17

for.cond96:                                       ; preds = %for.update98, %for.init95
  %__idx_num100 = load i64, ptr %__idx_num, align 4, !dbg !17
  %__len_num101 = load i64, ptr %__len_num, align 4, !dbg !17
  %icmpslttmp = icmp slt i64 %__idx_num100, %__len_num101, !dbg !17
  br i1 %icmpslttmp, label %for.body97, label %for.exit99, !dbg !17

for.body97:                                       ; preds = %for.cond96
  %__idx_num102 = load i64, ptr %__idx_num, align 4, !dbg !17
  %vec.data_ptr103 = getelementptr inbounds { ptr, i64, i64 }, ptr %numbers, i32 0, i32 0, !dbg !17
  %vec.size_ptr104 = getelementptr inbounds { ptr, i64, i64 }, ptr %numbers, i32 0, i32 1, !dbg !17
  %vec.data105 = load ptr, ptr %vec.data_ptr103, align 8, !dbg !17
  %vec.size = load i64, ptr %vec.size_ptr104, align 4, !dbg !17
  %vec.offset106 = mul i64 %__idx_num102, 8, !dbg !17
  ...
  %num109 = load i64, ptr %num, align 4, !dbg !17
  %addtmp = add i64 %sum108, %num109, !dbg !17
  store i64 %addtmp, ptr %sum, align 4, !dbg !17
  br label %for.update98, !dbg !17

for.update98:                                     ; preds = %for.body97
  %__idx_num110 = load i64, ptr %__idx_num, align 4, !dbg !17
  %addtmp111 = add i64 %__idx_num110, 1, !dbg !17
  store i64 %addtmp111, ptr %__idx_num, align 4, !dbg !17
  br label %for.cond96, !dbg !17
...
!1 = !DIFile(filename: "test_chained_push.vyn.ll", directory: "/home/rick/Projects/Vyn/test/vec_for")
...
!12 = !DILocalVariable(name: "__run_once_num", scope: !4, file: !1, line: 9, type: !13)
!13 = !DIBasicType(name: "bool", size: 1, encoding: DW_ATE_boolean)
!14 = !DILocalVariable(name: "__len_num", scope: !4, file: !1, line: 9, type: !7)
!15 = !DILocalVariable(name: "__idx_num", scope: !4, file: !1, line: 9, type: !7)
!16 = !DILocalVariable(name: "num", scope: !4, file: !1, line: 9, type: !7)
