...
@filepath.str = private unnamed_addr constant [50 x i8] c"test/trap/multi_type/trap_multi_then_wildcard.vyn\00", align 1
...
block.normal:                                     ; preds = %entry
  ...
  store i64 777, ptr %error.data.ptr, align 4, !dbg !8
...
!1 = !DIFile(filename: "trap_multi_then_wildcard.vyn.ll", directory: "/home/runner/work/Vyn/Vyn/test/trap/multi_type")
