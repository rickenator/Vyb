...
@filepath.str = private unnamed_addr constant [43 x i8] c"test/trap/multi_type/trap_multi_direct.vyn\00", align 1
...
block.normal:                                     ; preds = %entry
  ...
  store i64 42, ptr %error.data.ptr, align 4, !dbg !8
...
trap.landing:                                     ; preds = %block.normal
  ...
  br i1 %type.matches.or2, label %trap.handler0, label %trap.unmatched, !dbg !8
...
!1 = !DIFile(filename: "trap_multi_direct.vyn.ll", directory: "/home/runner/work/Vyn/Vyn/test/trap/multi_type")
