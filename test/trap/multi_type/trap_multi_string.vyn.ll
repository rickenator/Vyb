...
@filepath.str = private unnamed_addr constant [43 x i8] c"test/trap/multi_type/trap_multi_string.vyn\00", align 1
...
block.normal:                                     ; preds = %entry
  ...
  store { ptr, i64 } { ptr @0, i64 5 }, ptr %error.data.ptr, align 8, !dbg !8
...
!1 = !DIFile(filename: "trap_multi_string.vyn.ll", directory: "/home/runner/work/Vyn/Vyn/test/trap/multi_type")
