...
@filepath.str = private unnamed_addr constant [48 x i8] c"test/trap/multi_type/trap_multi_three_types.vyn\00", align 1
...
trap.landing:                                     ; preds = %block.normal
  ...
  %error.typeid3 = load i64, ptr %error.ptr, align 4, !dbg !8
  %type.matches.Bool = icmp eq i64 %error.typeid3, -1012572155697241872, !dbg !8
  %type.matches.or4 = or i1 %type.matches.or2, %type.matches.Bool, !dbg !8
  br i1 %type.matches.or4, label %trap.handler0, label %trap.unmatched, !dbg !8
...
!1 = !DIFile(filename: "trap_multi_three_types.vyn.ll", directory: "/home/runner/work/Vyn/Vyn/test/trap/multi_type")
