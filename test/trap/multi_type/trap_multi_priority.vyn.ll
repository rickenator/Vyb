...
@filepath.str = private unnamed_addr constant [45 x i8] c"test/trap/multi_type/trap_multi_priority.vyn\00", align 1
...
block.normal:                                     ; preds = %entry
  ...
  store i64 123, ptr %error.data.ptr, align 4, !dbg !8
...
trap.check1:                                      ; preds = %trap.landing
  ...
  %type.matches.Int = icmp eq i64 %error.typeid1, -3994496327427856726, !dbg !8
  %type.matches.or = or i1 false, %type.matches.Int, !dbg !8
  %error.typeid2 = load i64, ptr %error.ptr, align 4, !dbg !8
  %type.matches.String = icmp eq i64 %error.typeid2, 7563291569981072216, !dbg !8
  %type.matches.or3 = or i1 %type.matches.or, %type.matches.String, !dbg !8
...
!1 = !DIFile(filename: "trap_multi_priority.vyn.ll", directory: "/home/runner/work/Vyn/Vyn/test/trap/multi_type")
