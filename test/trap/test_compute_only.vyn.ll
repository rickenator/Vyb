...
entry:
  %result = alloca i64, align 8, !dbg !29
  %calltmp = call { i64, ptr } @compute(i64 10, i64 2), !dbg !29
  ...
  br i1 %has.error, label %call.error1, label %call.success, !dbg !29

call.error1:                                      ; preds = %entry
  call void @__vyn_runtime_untrapped_error(ptr null), !dbg !29
  unreachable, !dbg !29

call.success:                                     ; preds = %entry
  store i64 %call.value, ptr %result, align 4, !dbg !29
  call void @llvm.dbg.declare(metadata ptr %result, metadata !28, metadata !DIExpression()), !dbg !30
  %result2 = load i64, ptr %result, align 4, !dbg !29
  ret i64 %result2, !dbg !29
}
