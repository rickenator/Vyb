...
call.success:                                     ; preds = %entry
  ...
  store i64 100, ptr %val2, align 4, !dbg !30
  call void @llvm.dbg.declare(metadata ptr %val2, metadata !29, metadata !DIExpression()), !dbg !32
  %val12 = load i64, ptr %val1, align 4, !dbg !30
  %val23 = load i64, ptr %val2, align 4, !dbg !30
  %addtmp = add i64 %val12, %val23, !dbg !30
...
!1 = !DIFile(filename: "test_no_trap.vyn.ll", directory: "/home/rick/Projects/Vyn/test/trap")
