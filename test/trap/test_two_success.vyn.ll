...
call.success:                                     ; preds = %entry
  ...
  %calltmp2 = call { i64, ptr } @compute(i64 6, i64 3), !dbg !30
...
call.success7:                                    ; preds = %call.success
  store i64 %call.value3, ptr %val2, align 4, !dbg !30
...
!1 = !DIFile(filename: "test_two_success.vyn.ll", directory: "/home/rick/Projects/Vyn/test/trap")
