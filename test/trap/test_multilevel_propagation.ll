...
then:                                             ; preds = %entry
  ...
  store i64 -3994496327427856726, ptr %error.typeid.ptr, align 4, !dbg !12
...
call.success:                                     ; preds = %entry
  ...
  %trap_error_heap = call ptr @malloc(i64 8), !dbg !30
  store ptr null, ptr %trap_error_heap, align 8, !dbg !30
...
block.continue:                                   ; preds = %trap.handler0, %call.success7
  ...
  call void @free(ptr %trap_error_heap), !dbg !30
...
call.error6:                                      ; preds = %block.normal
  store ptr %call.error4, ptr %trap_error_heap, align 8, !dbg !30
...
!1 = !DIFile(filename: "test_multilevel_propagation.ll", directory: "/home/rick/Projects/Vyn/test/trap")
!2 = !{i32 2, !"Debug Info Version", i32 3}
!3 = !{i32 2, !"Dwarf Version", i32 4}
!4 = distinct !DISubprogram(name: "divide", linkageName: "divide", scope: !1, file: !1, line: 3, type: !5, scopeLine: 3, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !9)
...
!9 = !{!10, !11}
!10 = !DILocalVariable(name: "a", scope: !4, file: !1, line: 3, type: !8)
!11 = !DILocalVariable(name: "b", scope: !4, file: !1, line: 3, type: !8)
!12 = !DILocation(line: 3, column: 1, scope: !4)
!13 = !DILocation(line: 3, column: 9, scope: !4)
!14 = !DILocation(line: 3, column: 17, scope: !4)
!15 = distinct !DISubprogram(name: "compute", linkageName: "compute", scope: !1, file: !1, line: 8, type: !5, scopeLine: 8, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !16)
!16 = !{!17, !18, !19}
!17 = !DILocalVariable(name: "x", scope: !15, file: !1, line: 8, type: !8)
!18 = !DILocalVariable(name: "y", scope: !15, file: !1, line: 8, type: !8)
!19 = !DILocalVariable(name: "result", scope: !15, file: !1, line: 11, type: !8)
!20 = !DILocation(line: 8, column: 1, scope: !15)
!21 = !DILocation(line: 8, column: 10, scope: !15)
!22 = !DILocation(line: 8, column: 18, scope: !15)
!23 = !DILocation(line: 11, column: 1, scope: !15)
!24 = distinct !DISubprogram(name: "main", linkageName: "main", scope: !1, file: !1, line: 15, type: !25, scopeLine: 15, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !27)
!25 = !DISubroutineType(types: !26)
!26 = !{!8}
!27 = !{!28, !29}
!28 = !DILocalVariable(name: "val1", scope: !24, file: !1, line: 17, type: !8)
!29 = !DILocalVariable(name: "val2", scope: !24, file: !1, line: 20, type: !8)
!30 = !DILocation(line: 15, column: 1, scope: !24)
!31 = !DILocation(line: 17, column: 1, scope: !24)
!32 = !DILocation(line: 20, column: 1, scope: !24)
