...
@filepath.str.1 = private unnamed_addr constant [37 x i8] c"test/stdlib/error_multiple_types.vyn\00", align 1
@ParseError_message.str = private unnamed_addr constant [19 x i8] c"ParseError_message\00", align 1
@filepath.str.2 = private unnamed_addr constant [37 x i8] c"test/stdlib/error_multiple_types.vyn\00", align 1
@ParseError_code.str = private unnamed_addr constant [16 x i8] c"ParseError_code\00", align 1
@filepath.str.3 = private unnamed_addr constant [37 x i8] c"test/stdlib/error_multiple_types.vyn\00", align 1
@readAndParse.str = private unnamed_addr constant [13 x i8] c"readAndParse\00", align 1
@filepath.str.4 = private unnamed_addr constant [37 x i8] c"test/stdlib/error_multiple_types.vyn\00", align 1
@0 = private unnamed_addr constant [10 x i8] c"Not found\00", align 1
@1 = private unnamed_addr constant [9 x i8] c"/missing\00", align 1
...
entry:
  ...
  call void @__vyn_runtime_push_call_frame(ptr @readAndParse.str, ptr @filepath.str.4, i32 41, i32 1), !dbg !11
...
then:                                             ; preds = %entry
  ...
  store i64 2, ptr %code_ptr, align 4, !dbg !11
  %path_ptr = getelementptr inbounds %IOError, ptr %IOError_obj, i32 0, i32 2, !dbg !11
  store { ptr, i64 } { ptr @1, i64 8 }, ptr %path_ptr, align 8, !dbg !11
...
ifcont:                                           ; preds = %entry
  ...
  store { ptr, i64 } { ptr @2, i64 10 }, ptr %message_ptr3, align 8, !dbg !11
  %code_ptr4 = getelementptr inbounds %ParseError, ptr %ParseError_obj, i32 0, i32 1, !dbg !11
  store i64 1, ptr %code_ptr4, align 4, !dbg !11
...
entry:
  ...
  call void @__vyn_runtime_push_call_frame(ptr @main.str, ptr @filepath.str.5, i32 50, i32 1), !dbg !18
...
block.normal:                                     ; preds = %entry
  %calltmp = call { i64, ptr } @readAndParse(i64 1), !dbg !18
...
block.continue:                                   ; preds = %call.success
  ...
  %result6 = load i64, ptr %result, align 4, !dbg !18
  call void @__vyn_runtime_pop_call_frame(), !dbg !18
  ret i64 %result6, !dbg !18
...
trap.landing:                                     ; preds = %call.error1
  ...
  %type.matches = icmp eq i64 %error.typeid, -4894357878115938473, !dbg !18
  br i1 %type.matches, label %trap.handler0, label %trap.check1, !dbg !18
...
trap.handler0:                                    ; preds = %trap.landing
  %error.data.i8ptr = getelementptr i8, ptr %error.ptr, i64 8, !dbg !18
  %error.value = load %IOError, ptr %error.data.i8ptr, align 8, !dbg !18
  call void @__vyn_runtime_pop_call_frame(), !dbg !18
  ret i64 10, !dbg !18

trap.check1:                                      ; preds = %trap.landing
  %error.typeid2 = load i64, ptr %error.ptr, align 4, !dbg !18
  %type.matches3 = icmp eq i64 %error.typeid2, 2394716306558183473, !dbg !18
  br i1 %type.matches3, label %trap.handler1, label %trap.unmatched, !dbg !18

trap.handler1:                                    ; preds = %trap.check1
  %error.data.i8ptr4 = getelementptr i8, ptr %error.ptr, i64 8, !dbg !18
  %error.value5 = load %ParseError, ptr %error.data.i8ptr4, align 8, !dbg !18
  call void @__vyn_runtime_pop_call_frame(), !dbg !18
  ret i64 20, !dbg !18
}
...
!12 = !DILocation(line: 41, column: 18, scope: !4)
!13 = distinct !DISubprogram(name: "main", linkageName: "main", scope: !1, file: !1, line: 50, type: !14, scopeLine: 50, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !16)
!14 = !DISubroutineType(types: !15)
!15 = !{!8}
!16 = !{!17}
!17 = !DILocalVariable(name: "result", scope: !13, file: !1, line: 51, type: !8)
!18 = !DILocation(line: 50, column: 1, scope: !13)
!19 = !DILocation(line: 51, column: 1, scope: !13)
