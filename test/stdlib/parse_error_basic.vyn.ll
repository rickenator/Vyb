...
entry:
  ...
  %member_load = load { ptr, i64 }, ptr %message_ptr, align 8, !dbg !28
  call void @__vyn_runtime_pop_call_frame(), !dbg !28
  ret { ptr, i64 } %member_load, !dbg !28
}
...
entry:
  ...
  %member_load = load { ptr, i64 }, ptr %message_ptr, align 8, !dbg !40
  call void @__vyn_runtime_pop_call_frame(), !dbg !40
  ret { ptr, i64 } %member_load, !dbg !40
}
...
!1 = !DIFile(filename: "parse_error_basic.vyn.ll", directory: "/home/rick/Projects/Vyn/test/stdlib")
