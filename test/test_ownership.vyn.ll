...
@0 = private unnamed_addr constant [30 x i8] c"Created Vec with my ownership\00", align 1
@1 = private unnamed_addr constant [24 x i8] c"Created inner scope Vec\00", align 1
@2 = private unnamed_addr constant [44 x i8] c"Inner scope exited, v2 should be cleaned up\00", align 1
@3 = private unnamed_addr constant [40 x i8] c"Testing ownership and memory management\00", align 1
@4 = private unnamed_addr constant [31 x i8] c"Basic ownership test completed\00", align 1
@5 = private unnamed_addr constant [30 x i8] c"All ownership tests completed\00", align 1

define void @test_basic_ownership() {
entry:
...
entry:
  ...
  call void @test_basic_ownership()
