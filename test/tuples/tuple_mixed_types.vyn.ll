...
define { i64, { ptr, i64 }, i1 } @main() !dbg !4 {
entry:
  ret { i64, { ptr, i64 }, i1 } { i64 42, { ptr, i64 } { ptr @0, i64 4 }, i1 true }, !dbg !8
}
...
!1 = !DIFile(filename: "tuple_mixed_types.vyn.ll", directory: "/home/rick/Projects/Vyn/test/tuples")
