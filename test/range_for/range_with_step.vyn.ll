...
for.cond:                                         ; preds = %for.update, %for.init
  ...
  %icmpsletmp = icmp sle i64 %i1, 10, !dbg !11
...
!1 = !DIFile(filename: "range_with_step.vyn.ll", directory: "/home/rick/Projects/Vyn/test/range_for")
