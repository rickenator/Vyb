...
entry:
  ...
  store i64 0, ptr %count, align 4, !dbg !11
  call void @llvm.dbg.declare(metadata ptr %count, metadata !9, metadata !DIExpression()), !dbg !12
  br label %for.init, !dbg !11

for.init:                                         ; preds = %entry
  store i64 1, ptr %i, align 4, !dbg !11
...
for.cond:                                         ; preds = %for.update, %for.init
  ...
  %icmpsletmp = icmp sle i64 %i1, 100, !dbg !11
  br i1 %icmpsletmp, label %for.body, label %for.exit, !dbg !11

for.body:                                         ; preds = %for.cond
  %count2 = load i64, ptr %count, align 4, !dbg !11
  %addtmp = add i64 %count2, 1, !dbg !11
  store i64 %addtmp, ptr %count, align 4, !dbg !11
  br label %for.update, !dbg !11

for.update:                                       ; preds = %for.body
  %i3 = load i64, ptr %i, align 4, !dbg !11
  %addtmp4 = add i64 %i3, 10, !dbg !11
  store i64 %addtmp4, ptr %i, align 4, !dbg !11
  br label %for.cond, !dbg !11

for.exit:                                         ; preds = %for.cond
  %count5 = load i64, ptr %count, align 4, !dbg !11
  ret i64 %count5, !dbg !11
}
...
!1 = !DIFile(filename: "range_step_large.vyn.ll", directory: "/home/rick/Projects/Vyn/test/range_for")
...
!8 = !{!9, !10}
!9 = !DILocalVariable(name: "count", scope: !4, file: !1, line: 3, type: !7)
