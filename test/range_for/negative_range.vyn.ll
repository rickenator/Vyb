...
for.init:                                         ; preds = %entry
  store i64 -5, ptr %i, align 4, !dbg !11
...
for.cond:                                         ; preds = %for.update, %for.init
  ...
  %icmpsletmp = icmp sle i64 %i1, 4, !dbg !11
...
!1 = !DIFile(filename: "negative_range.vyn.ll", directory: "/home/rick/Projects/Vyn/test/range_for")
