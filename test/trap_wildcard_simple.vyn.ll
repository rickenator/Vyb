...
@filepath.str = private unnamed_addr constant [30 x i8] c"test/trap_wildcard_simple.vyn\00", align 1
...
@filepath.str.1 = private unnamed_addr constant [30 x i8] c"test/trap_wildcard_simple.vyn\00", align 1
...
!1 = !DIFile(filename: "trap_wildcard_simple.vyn.ll", directory: "/home/rick/Projects/Vyn/test")
...
!13 = !{!14}
!14 = !DILocalVariable(name: "result", scope: !9, file: !1, line: 8, type: !12)
