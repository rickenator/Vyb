#!/bin/bash
# Demonstrate Vyn call stack traces

echo "╔════════════════════════════════════════════════════════════════════════════╗"
echo "║              Vyn Call Stack Traces - Live Demonstration                    ║"
echo "╚════════════════════════════════════════════════════════════════════════════╝"
echo ""
...
echo ""
./build/vyn test/stack_trace_nested.vyn 2>&1 | grep -A12 "UNTRAPPED FAILURE"
echo ""
echo ""
...
echo ""
./build/vyn test/stack_trace_deep.vyn 2>&1 | grep -A15 "UNTRAPPED FAILURE"
echo ""
echo ""
...
echo "║                              KEY FEATURES                                  ║"
echo "╠════════════════════════════════════════════════════════════════════════════╣"
echo "║ ✓ Shows Vyn function names (not native/mangled C++ names)                  ║"
