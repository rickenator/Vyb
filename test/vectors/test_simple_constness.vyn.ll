...
entry:
  ...
  %vec.size_ptr1 = getelementptr inbounds { ptr, i64, i64 }, ptr %mutable_vec, i32 0, i32 1
  ...
  %vec.size_ptr4 = getelementptr inbounds { ptr, i64, i64 }, ptr %mutable_vec, i32 0, i32 1
  %vec.len = load i64, ptr %vec.size_ptr4, align 4
  store i64 %vec.len, ptr %len1, align 4
  ret i64 0
}
