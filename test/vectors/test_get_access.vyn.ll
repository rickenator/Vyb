...
@0 = private unnamed_addr constant [18 x i8] c"Sized Vec created\00", align 1
@1 = private unnamed_addr constant [30 x i8] c"Element accessed successfully\00", align 1

define i64 @main() {
entry:
  %first_element = alloca i64, align 8
  %sized_vec = alloca { ptr, i64, i64 }, align 8
  ...
  store { ptr, i64, i64 } %vec.new.value, ptr %sized_vec, align 8
