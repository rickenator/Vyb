...
@0 = private unnamed_addr constant [19 x i8] c"Simple test passed\00", align 1

define i64 @main() {
entry:
  %simple_vec = alloca { ptr, i64, i64 }, align 8
  ...
  store { ptr, i64, i64 } %vec.new.value, ptr %simple_vec, align 8
  %vec.size_ptr = getelementptr inbounds { ptr, i64, i64 }, ptr %simple_vec, i32 0, i32 1
