...
```bash
# 1148 .vyb tests exercised through compile + run + output/return checks
...
```bash
python3 test/run_tests.py --vyb ./build/vyb --test-dir test --execute-jit   # full suite (1148 tests)
